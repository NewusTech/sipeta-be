...
route.post('/datatoponim/import-shp', [mid.checkRoles()], upload.fields([{ name: 'shp', maxCount: 1 }, { name: 'shx', maxCount: 1 }, { name: 'dbf', maxCount: 1 }]), importtoponimController.importShp);
